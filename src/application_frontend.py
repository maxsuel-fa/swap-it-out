...
def options_screen():
    ...
    print('\t\t\t\t|                                                            |')
    print('\t\t\t\t| 2) CADASTRAR ALBUM                                         |')
    print('\t\t\t\t|                                                            |')
    print('\t\t\t\t| 3) CADASTRAR FIGURINHA                                     |')
    print('\t\t\t\t|                                                            |')
    print('\t\t\t\t| 5) BUSCAR FIGURINHA DE UM COLECIONADOR                     |')
    print('\t\t\t\t|                                                            |')
    print('\t\t\t\t| 6) BUSCAR PORCENTAGEM COMPLETA DO ALBUM PARA UM            |')
    print('\t\t\t\t|    COLECIONADOR                                            |')
    print('\t\t\t\t|                                                            |')
    print('\t\t\t\t| 7) REGISTRAR TROCA                                         |')
    print('\t\t\t\t|                                                            |')
    print('\t\t\t\t| 8) SAIR DA APLICACAO                                       |')
    print('\t\t\t\t+------------------------------------------------------------+')
